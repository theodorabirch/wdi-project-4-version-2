                    ...
                    <div className="card is-shady">
                      ...
                      <div className="card-image">
                        <figure className="image is-4by4">
                          {isAuthenticated() && <Link to={`/workout/${workout._id}/edit`}>
                      ...
                      <div className="card-content index-content">
                        <div className="content">
                          ...
                          <span className="date-val">{workout.exercise.date.split('-')[2].substring(0, 2)}/{workout.date.split('-')[1]}/{workout.date.split('-')[0]} </span><br /><br />
                          <div className="card">
                            <h4><i className="fas fa-fire cal-burn"></i> {workout.totalCaloriesBurned}<span className="stat-unit">kCals</span></h4>
                        </div>
                      </div>
                    </div>
                  </div>
